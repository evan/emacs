    ...
    `(((foreground-color . ,foreground)
      ...
      ,@(append extra-faces
                `((default ((t (:foreground ,foreground :background ,background :stipple nil
                  ...
                  (modeline ((t (:foreground ,background :background ,foreground))))
                  (modeline-buffer-id ((t (:foreground ,background :background ,foreground))))
                  (modeline-mousable ((t (:foreground ,background :background ,foreground))))
                  (modeline-mousable-minor-mode ((t (:foreground ,background :background ,foreground))))
   ...
   `(color-theme-mf-dark
     ,@(mf-color-theme-template
        ...
        '((fringe ((t (:background "#171717"))))
          ...
          (modeline ((t (:foreground "white" :background "#222222" :box (:line-width 1 :color "#222222")))))
          (modeline-buffer-id ((t (:foreground nil :background nil))))
          (modeline-mousable ((t (:foreground nil :background nil))))
          (modeline-mousable-minor-mode ((t (:foreground nil :background nil))))
          (modeline-inactive ((t (:inherit modeline :foreground "#444444" :background "#222222" :box (:line-width 1 :color "#222222")))))
   ...
   `(color-theme-mf-light
     ,@(mf-color-theme-template
        ...
        '((fringe ((t (:background "white"))))
          (modeline ((t (:background "grey30" :foreground "white" :box (:line-width 1 :color "grey20")))))
          (modeline-buffer-id ((t (:foreground nil :background nil))))
          (modeline-mousable ((t (:foreground nil :background nil))))
          (modeline-mousable-minor-mode ((t (:foreground nil :background nil))))
          (modeline-inactive ((t (:inherit modeline :background "grey90" :foreground "grey20" :box (:line-width 1 :color "grey75") :weight light))))
